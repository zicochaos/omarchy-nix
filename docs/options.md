...
`zcode-desktop`, `hermes-agent`). The managed-packages block resolves a
catalog attr through nixpkgs first and through this set second. Set
automatically by the flake's
